  ...
  const navigate = useNavigate();
   ...
   useEffect(() => {
    const fetchData = async () => {
      const postData = await fetchPosts('jayou'); // 다른 컬렉션 이름 전달
      setPosts(postData);
    };
